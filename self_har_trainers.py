...
def composite_train_model(
    ...
    best_model_file_name = os.path.join(working_directory, "models", f"{tag}_best.keras")
    last_model_file_name = os.path.join(working_directory, "models", f"{tag}_last.keras")
